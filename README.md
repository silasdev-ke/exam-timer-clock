# Exam Timer – Dual View Clock + Timer
...
```bash
git clone https://github.com/silasdev-ke/exam-timer-clock.git
cd exam-timer-clock
...
After creating the file, add and commit it:
...
![Screenshot](images/screenshots/screenshot-mobile.png)
![Screenshot](images/screenshots/screenshot-mobile-1.png)
